...
?>
              ...
              <div class="col-md-6 mb-2">
              <p><strong>Date Completed:</strong> <?php 
echo isset($transactionDetails['date_completed']) && !empty($transactionDetails['date_completed']) 
    ? date("F d, Y", strtotime($transactionDetails['date_completed'])) 
    : "Not Yet Completed ";
?>
              </div>
