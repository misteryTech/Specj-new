...
function selectService(button) {
    ...
    let existingItem = [...selectedProduct.children].find(item => item.dataset.serviceId === serviceId);
    if (existingItem) {
...
function updateTotal() {
    ...
    document.querySelectorAll("#selectedProduct li").forEach(item => {
        ...
        selectedServices.push({ serviceId: item.dataset.serviceId, quantity: quantity });
    });
